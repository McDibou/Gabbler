...
function insertMessage($content, $db, $user,$room)
{

    mysqli_query($db, "INSERT INTO `message` (`content_message`, `archived_message`, `fkey_user_id`, `fkey_room_id`) VALUES ('$content', 0, '$user', '$room')");
